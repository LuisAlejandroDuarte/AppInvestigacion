 ...
 private function grupo() {  
   ...
   private function login() {  
    if ($_SERVER['REQUEST_METHOD'] != "GET") {  
      ...
      $query = "Select * from sgi_inve where INV_USER='" . $usuario . "' and INV_PASS='" . $pwd . "'";
       ...
       if (mysqli_num_rows($result)>0)
        {
         ...
         $message[0] = array('Id_inve'=>$usua['INV_CODI'], 'Id' => $usua['INV_CODI'],'clave'=> $usua['INV_PASS'],'Usuario' => $usua['INV_USER']);
